...
export default function ContactModal({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      {/* Modal container — rounded-2xl, border-2 border-black, hard flat shadow */}
      <div
        className={`bg-white w-full max-w-sm rounded-2xl border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden transition-all duration-300 ${
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 pt-5 pb-3">
          ...
          <button
            onClick={onClose}
            className="text-xl font-black text-gray-700 hover:text-black transition-colors leading-none"
            aria-label="Close"
          >
            ✕
          </button>
        ...
        <div className="flex flex-col gap-2.5 px-4 pb-3">
          {links.map(({ Icon, label, href, bgClass, textClass }) => (
            <a
              key={label}
              href={href}
              target={href.startsWith('mailto') ? undefined : '_blank'}
              rel="noopener noreferrer"
              className={`flex items-center gap-3 px-4 py-3 rounded-xl border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] font-bold text-sm transition-all duration-100 hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none ${bgClass} ${textClass}`}
        ...
        <div className="px-4 pb-5 pt-1">
          <button
            onClick={onClose}
            className="w-full py-3.5 bg-[#F87171] text-white font-black text-sm tracking-widest rounded-xl border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-100 hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none"
            style={{ fontFamily: "'Inter', sans-serif" }}
          >
            CLOSE
          </button>
